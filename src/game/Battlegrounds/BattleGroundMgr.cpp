...
void BattleGroundQueue::Update(BattleGroundTypeId bgTypeId, BattleGroundBracketId bracketId)
{
    ...
    for (int attempt = 0; attempt < normalMatchesCreationAttempts; ++attempt)
    {
        ...
        if (BattleGroundMgr::IsArena(bgTypeId))
        {
            if (CheckNormalMatch(bracketId, minPlayersPerTeam, MaxPlayersPerTeam) || CheckSkirmishForSameFaction(bracketId, minPlayersPerTeam) || CheckCrossFactionMatch(bracketId, bg_template))
            {
...
BattleGround* BattleGroundMgr::CreateNewBattleGround(BattleGroundTypeId bgTypeId, BattleGroundBracketId bracketId)
{
    ...
    switch (bgTypeId)
    {
        ...
        case BATTLEGROUND_DS3v3:
        case BATTLEGROUND_DS5v5:
            bg = new Arena(*(Arena*)bg_template);
            break;
